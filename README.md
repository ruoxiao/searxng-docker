...
| [SearXNG](https://github.com/ruoxiao/searxng) | SearXNG by itself | [ruoxiao/searxng:latest](https://hub.docker.com/r/searxng/searxng) | [Dockerfile](https://github.com/ruoxiao/searxng/blob/master/Dockerfile) |
...
- Get searxng-docker
  ```sh
  cd /usr/local
  git clone https://github.com/ruoxiao/searxng-docker.git
  cd searxng-docker
  ```
- Edit the [.env](https://github.com/ruoxiao/searxng-docker/blob/master/.env) file to set the hostname and an email
- Generate the secret key `sed -i "s|ultrasecretkey|$(openssl rand -hex 32)|g" searxng/settings.yml`
- Edit the [searxng/settings.yml](https://github.com/ruoxiao/searxng-docker/blob/master/searxng/settings.yml) file according to your need
...
If some users wants to disable the image proxy, you have to modify [./Caddyfile](https://github.com/ruoxiao/searxng-docker/blob/master/Caddyfile). Replace the ```img-src 'self' data: https://*.tile.openstreetmap.org;``` by ```img-src * data:;```.
